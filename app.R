                ...
                navbarPage("NEW YORK CITY RENT EXPLORER", collapsible = TRUE,
                           ...
                           sidebarLayout(
                                sidebarPanel(
                                  ...
                                  p("This web application is proudly made by", a(href = "https://www.linkedin.com/in/jvosteen/", "Josh Vera O'Steen", .noWS=c("after")),",", a(href = "https://www.linkedin.com/in/yasharmansouri/", "Yashar Mansouri", .noWS=c("after")), ", and", a(href = "https://www.linkedin.com/in/christopher-hoffmann/", "Christopher Hoffman", .noWS=c("after")),". For contact information and further details on this project, please refer to the README and Vignette files found in Josh's",
                                    a(href = "https://github.com/JVOsteen/NYCRentExplorer", "GitHub repository", .noWS=c("after")), "."),
